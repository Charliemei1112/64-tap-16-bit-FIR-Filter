...
#########################################
set top_level datapath
source -verbose "../common_script/common.tcl"
read_verilog "../../rtl/$top_level/$top_level.v"
read_verilog "../../dc/alu/alu.nl.v"
read_verilog "../../dc/cmem/cmem.nl.v"
read_verilog "../../dc/imem/imem.nl.v"
read_verilog "../../dc/fifo/fifo.nl.v"
...
set_max_capacitance 5 [all_inputs]
