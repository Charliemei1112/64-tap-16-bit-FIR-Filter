...
## Setting files/paths
set top_level imem
set verilog_files "../../dc/$top_level/$top_level.nl.v"
...
## Run STA 
###################################################
set rpt_file "./${top_level}_pt.rpt"
check_timing
...
read_vcd "../../qsim_dc/imem/imem.vcd" -strip_path "testbench/imem_0"
...
write_sdf -context verilog "./imem.sdf"
